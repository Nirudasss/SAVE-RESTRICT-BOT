...
async def send_start(client: Client, message: Message):
    ...
    await client.send_message(
        ...
        text=(
            ...
            "<b>I am the Advanced Save Restricted Content Bot by EliteBots.</b>\n\n"
...
async def button_callbacks(client: Client, callback_query):
    ...
    # About button
        ...
        about_text = (
            ...
            "• 👨‍💻 𝐎𝐰𝐧𝐞𝐫 : <a href='https://t.me/PRESIDENTIND7'>President</a>\n"
            "• 📡 𝐔𝐩𝐝𝐚𝐭𝐞𝐬 : <a href='https://t.me/Radha_Rani_Backup'>EliteBotz</a>\n"
